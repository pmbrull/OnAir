...
| Auto-update (Sparkle, its feed and its keys) | `brew upgrade` stops being how this audience updates (ADR-0016) |
| CI-held release signing | a second maintainer needs to cut a release (ADR-0016) |
