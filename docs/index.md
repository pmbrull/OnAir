...
| [`runbooks/`](runbooks/) | Manual procedures. [`first-run.md`](runbooks/first-run.md): the user side — connect, get past the certificate warning. [`shared-app.md`](runbooks/shared-app.md): the maintainer side — create the shared Slack app, once ever. [`release.md`](runbooks/release.md): cut a release — certificate, notarization, tag, tap. |
